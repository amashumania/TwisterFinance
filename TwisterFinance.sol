...
contract TwisterFinance is IERC20, Ownable {
    using SafeMath for uint256;

    string constant _name = "Twister Finance";
    string constant _symbol = "Twister Finance";
    ...
    constructor() {
        ...
        marketingWallet = 0xF12dad5604042d8F2a3dF4eF44b9EA52d4142B56;
        ...
        totalFeeIfSelling = totalFee + 300;
